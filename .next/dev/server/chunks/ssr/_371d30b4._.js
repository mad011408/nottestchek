module.exports = [
"[project]/lib/utils/file-utils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/token-utils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$main$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/gpt-tokenizer@3.4.0/node_modules/gpt-tokenizer/esm/main.js [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/gpt-tokenizer@3.4.0/node_modules/gpt-tokenizer/esm/encoding/o200k_base.js [app-ssr] (ecmascript)");
;
 ...
 */ const countPartTokens = (part, fileTokens = {})=>{
    if (part.type === "text" && "text" in part) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["countTokens"])(part.text || "");
    }
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["countTokens"])(JSON.stringify(part));
};
/**
...
const truncateContent = (content, marker = TRUNCATION_MESSAGE)=>{
    const tokens = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encode"])(content);
    if (tokens.length <= TOOL_DEFAULT_MAX_TOKENS) return content;
    const markerTokens = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["countTokens"])(marker);
    if (TOOL_DEFAULT_MAX_TOKENS <= markerTokens) {
        return TOOL_DEFAULT_MAX_TOKENS <= 0 ? "" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decode"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encode"])(marker).slice(-TOOL_DEFAULT_MAX_TOKENS));
    }
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decode"])(headTokens) + marker + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decode"])(tailTokens);
};
const sliceByTokens = (content, maxTokens)=>{
    if (maxTokens <= 0) return "";
    const tokens = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encode"])(content);
    if (tokens.length <= maxTokens) return content;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decode"])(tokens.slice(0, maxTokens));
};
const countInputTokens = (input, uploadedFiles = [])=>{
    const textTokens = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gpt$2d$tokenizer$40$3$2e$4$2e$0$2f$node_modules$2f$gpt$2d$tokenizer$2f$esm$2f$encoding$2f$o200k_base$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["countTokens"])(input);
...
"[project]/lib/utils/shiki.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$shiki$2f$langs__$5b$external$5d$__$28$shiki$2f$langs$2c$__esm_import$29$__ = __turbopack_context__.i("[externals]/shiki/langs [external] (shiki/langs, esm_import)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f$shiki$2f$langs__$5b$external$5d$__$28$shiki$2f$langs$2c$__esm_import$29$__
]);
[__TURBOPACK__imported__module__$5b$externals$5d2f$shiki$2f$langs__$5b$external$5d$__$28$shiki$2f$langs$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
// Create a Set of all supported language IDs and aliases from Shiki
const SUPPORTED_LANGUAGES = new Set(__TURBOPACK__imported__module__$5b$externals$5d2f$shiki$2f$langs__$5b$external$5d$__$28$shiki$2f$langs$2c$__esm_import$29$__["bundledLanguagesInfo"].flatMap((lang)=>[
        lang.id,
        ...lang.aliases || []
    ]));
...
"[project]/lib/utils/sidebar-utils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/actions/data:345811 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"00e0fc69e435c11a0011d1327cd40a4109cb0c8e65":"default"},"lib/actions/billing-portal.ts",""] */ __turbopack_context__.s([
    "default",
...
"[project]/lib/pricing/features.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const freeFeatures = [
    {
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$556$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$sparkle$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Sparkle$3e$__["Sparkle"],
        text: "Access to basic AI model"
    },
    {
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$556$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$clock$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Clock$3e$__["Clock"],
        text: "Limited and slower responses"
    },
    {
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$556$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$brain$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Brain$3e$__["Brain"],
...
const proFeatures = [
    ...
    {
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$556$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$upload$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Upload$3e$__["Upload"],
        text: "Access to file uploads"
    },
    {
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$556$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$square$2d$terminal$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__SquareTerminal$3e$__["SquareTerminal"],
...
const teamFeatures = [
    ...
    {
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$lucide$2d$react$40$0$2e$556$2e$0_react$40$19$2e$2$2e$1$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$users$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Users$3e$__["Users"],
        text: "Advanced team + seat management"
    }
];
}),
"[project]/lib/utils/logout.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/utils/message-processor.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/types/chat.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const messageMetadataSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$13$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    feedbackType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$13$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        "positive",
        "negative"
    ])
});
...
//# sourceMappingURL=_371d30b4._.js.map